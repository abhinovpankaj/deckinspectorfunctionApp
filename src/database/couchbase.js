...
console.log("[Couchbase] DB_USERNAME:", DB_USERNAME ? "✓ Found" : "✗ Not found");
console.log("[Couchbase] DB_PASSWORD:", DB_PASSWORD ? "✓ Found" : "✗ Not found");
console.log("[Couchbase] DB_CONN_STR:", DB_CONN_STR ? "✓ Found" : "✗ Not found");
console.log("[Couchbase] DB_BUCKET_NAME:", DB_BUCKET_NAME ? "✓ Found" : "✗ Not found");
